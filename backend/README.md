...
## Project Structure
    ...
    ├── neighborhoodconnect_36187  # Django project configurations
...
1. Clone this repo and `cd neighborhoodconnect_36187`
...
2. Clone this repo and `cd neighborhoodconnect_36187`
